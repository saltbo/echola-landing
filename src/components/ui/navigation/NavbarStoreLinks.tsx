...
const NavbarStoreLinks = ({ storeLinks }: { storeLinks: { apple: string; google: string } }) => (
    <div className="flex gap-2.5 md:gap-3 md:justify-center">
        {storeLinks.apple && <a href={storeLinks.apple} target="_blank" rel="noopener noreferrer" className="group store-button">
        ...
        {storeLinks.google && <a href={storeLinks.google} target="_blank" rel="noopener noreferrer" className="group store-button">
