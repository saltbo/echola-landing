...
const Breadcrumbs = ({ items, homeHref = "/" }: { homeHref?: string; items: Array<{ label: string; href?: string }> }) => (
	<nav className="flex items-center gap-2 text-base text-body mb-8">
		<a href={homeHref} className="hover:text-heading p-2 -ml-2 transition-colors">
